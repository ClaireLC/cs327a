...
int main(int argc, char** argv) {
	...
	{ 
        ...
        // PART D - Uncomment the line below and use with the PART C controller to see what removing op-space dynamic decopuling does
        ...
        //PART B - Controller with no joint damping in the null space
        ...
        //PART C - Controller with null space joint damping
        command_torques = J0.transpose()*(L_hat*(dv0_des - op_task_kp*ee_error - op_task_kv*(v0 - v0_des)) + p_hat) +  // PD control in op. space to track trajectory
